...
function update() {
  ...
  if (fileInput.files.length === 1) {
    ...
    // check flag and images array length in order to create arrows to scroll through the slider
    if (arrowFlag === false && myImages.length === 2) {
      arrows.innerHTML += "<a class=\"prev\" onclick=\"switchSlide(-1)\">&#10094;</a> <a class=\"next\" onclick=\"switchSlide(1)\">&#10095;</a>";
      arrowFlag = true;
    }
...
/*
* PURPOSE: To begin the slideshow, if the slideshow button is selected
*/
